<?php
    ...
    if($password == $re_password){
        if($is_login == 0){
            ...
            $redis -> HMSET("$login:budynki",'ratusz',1,'tartak',1,'kamieniolom',1,'huta',1,'koszary',0,'spichlerz',0);
            $redis -> HMSET("$login:wymagania",'drewno',80,'kamien',150,'zelazo',100,'ludnosc',10,'czas', 3);
